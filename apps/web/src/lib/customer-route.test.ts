...
export function runCustomerRouteTests() {
  expectEqual(resolveCustomerRoute('/reservations/12345678-1234-1234-1234-123456789abc/payment-result?paymentKey=pk'), { kind: 'reservation-payment-result', pathname: '/reservations/12345678-1234-1234-1234-123456789abc/payment-result', reservationId: '12345678-1234-1234-1234-123456789abc' }, '토스 복귀 경로를 CMS와 분리한다')

...
- [ ] **Step 1: 실패하는 grant 수명주기 통합 테스트 작성**
...
- [ ] **Step 1: 실패하는 응답·불변성 HTTP 테스트 작성**
...
- [ ] **Step 3: locale별 저장 초안 응답 adapter 구현**
...
- [ ] **Step 4: token 검증과 public controller 구현**
...
- [ ] **Step 5: 404·410 exception handler 연결**
...
- [ ] **Step 1: 실패하는 관리자 Playwright 흐름 작성**
...
- [ ] **Step 4: 재사용 가능한 preview action 구현**
...
- [ ] **Step 5: 세 page type과 locale editor에 연결**
...
- [ ] **Step 4: preview API 응답·만료 header 읽기 구현**
...
- [ ] **Step 3: App preview state와 비fallback load 구현**
...
- [ ] **Step 5: 예약·결제·CTA를 UI와 handler 양쪽에서 차단**
